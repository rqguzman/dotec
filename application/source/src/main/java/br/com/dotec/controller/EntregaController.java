...
public class EntregaController 
{
	...
	{				
		...
		if(cepEntregaValida)
			result.include("mensagem", "{\"cep\": {\"habilitado\": true, \"error\" : \"Este endereço faz parte da nossa área de atuação\"}}");		
		else
			result.include("mensagem", "{\"cep\": {\"error\" : \"Seu endereço, infelizmente, não está dentro de nossa área de atendimento, entre em contato conosco para uma análise mais detalhada.\"}}");
	}	
}
