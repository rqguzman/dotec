        ...
        add_sheet: function (opts) {
            ...
            if (opts.url) {
                if (document.createStyleSheet) {
                    ...
                    tmp.type = 'text/css';
                    tmp.media = "all";
                    tmp.href = "/shared/js/themes/classic/style.css";
	...
	$(function() {
		...
		var u = navigator.userAgent.toLowerCase(),
			...
			css_string = '' + 
				...
				'.jstree a { display:inline-block; line-height:16px; height:16px; color:#FFF; font:normal 12px Calibri; white-space:nowrap; text-decoration:none; padding:1px 2px; margin:0; } ' + 
...
(function ($) {
	...
	$(function () {
		var css_string = '' + 
			'#vakata-contextmenu { display:none; position:absolute; margin:0; padding:0; min-width:120px; background:#3B4E56; border:1px solid #1D3641; z-index:10000; *width:120px; } ' + 
			...
			'#vakata-contextmenu li.vakata-separator { min-height:0; height:1px; line-height:1px; font-size:1px; overflow:hidden; margin:0 2px; background:#1D3641; /* border-top:1px solid #fefefe; */ padding:0; } ';
		$.vakata.css.add_sheet({ str : css_string });
		$.vakata.context.cnt
